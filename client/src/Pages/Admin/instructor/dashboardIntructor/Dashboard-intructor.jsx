...
import { WindowsOutlined, ArrowUpOutlined, ArrowDownOutlined, TrophyOutlined, UserAddOutlined, BookOutlined, TeamOutlined } from '@ant-design/icons';
import './Dashboard-Intructor.scss';
...
const courses = [
    {
      key: '1',
      image: 'https://i.pinimg.com/236x/ed/66/63/ed666327dd3ce274d94f2b3547155891.jpg', // Update with actual image path
    ...
    {
      key: '2',
      image: 'https://i.pinimg.com/236x/97/02/99/970299bccfa87fece07ca0b580f7e2cc.jpg', // Update with actual image path
  ...
  const coursesnew = [
    {
      key: '1',
      image: 'https://i.pinimg.com/236x/63/94/f5/6394f5e99919e42f3278307506b8e73e.jpg', // Update with actual image path
      title: 'Complete Python Bootcamp: Go from zero to hero in Python 3',
      time: 'First 2 days 22 hours',
      views: '1.5k',
      purchased: 500,
    ...
    {
      key: '2',
      image: 'https://i.pinimg.com/236x/9e/49/5e/9e495ec4a19556b9a47e7ac8a0ce9b06.jpg', // Update with actual image path
      title: 'The Complete JavaScript Course 2020: Build Real Projects!',
      time: 'Second 4 days 9 hours',
      views: '3.5',
      purchased: 300,
  ...
  const DashboardIntructor = () => {
    ...
    return (
        <div className="dashboard">
            <p><WindowsOutlined /> Intructor Dashboard </p>
            <Row gutter={16}>
                <Col span={6}>
                    <Card>
                ...
                <Col span={6}>
                    <Card>
                        ...
                        />
                        <div className="styled-box"style={{backgroundColor:'yellowgreen'}}>
                        <span>New 10</span>
                        </div>
                    </Card>
                </Col>
        ...
        <Col span={8}>
          <Card title="News">
            <div style={{ display: 'flex', alignItems: 'start' }}>
              ...
              <div >
                <img src={coursesnew[currentNews].image} alt={coursesnew[currentNews].title} style={{ width: '100%', maxHeight: '200px', objectFit: 'contain' }} />
          ...
          <Card title="Profile Analytics">
            ...
            <p>View: 17k <span style={{ color: 'red' }}>▼ 75%</span></p>
            <p>Purchased (per hour): 1 <span style={{ color: 'red' }}>▼ 100%</span></p>
            <p>Enroll (per hour): 50 <span style={{ color: 'red' }}>▼ 70%</span></p>
          </Card>
          <Row >
                <Col span={80}>
                    <Card title="Submit Courses">
                        <p>The Complete JavaScript Course 2020: Build Real Projects!</p>
                        <Button type="primary" danger>Pending</Button>
                    </Card>
                </Col>
            </Row>
            <Row >
